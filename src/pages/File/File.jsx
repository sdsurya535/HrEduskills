...
const products = [
  {
    id: 1,
    Category: "suryaduttadash@gmail.com",
    Company: "Apple",
    Product: "iPhone 13",
...
const Table = () => {
  ...
  return (
    <div className=" overflow-x-auto lg:overflow-x-auto xl:overflow-x-none  mx-auto h-full bg-white flex  items-center justify-center pt-10 pb-14">
      <div className="w-full lg:max-w-screen-2xl xl:max-w-screen-2xl px-2">
        <div>
          <h1 className="text-2xl font-medium">Hr Eduskills Awards</h1>
        </div>
